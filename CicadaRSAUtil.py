...
class Handler:
    def handle(self):
        ...
        parser.add_argument(
            "action",
            choices=["generateps", "encryptps", "decryptps", "pgpverify", "pgpdecrypt", "decryptall", "decryptpage", "encryptall", "encryptpage"],
    ...
    def encryptps(self):
        ...
        nbase1str = ""
        for res in nbase1:
            nbase1str += IndexToRunes[res%29]

        nbase2str = ""
        for res2 in nbase2:
            nbase2str += IndexToRunes[res2%29]
    ...
    def decryptall(self):
        ...
        for i in nbase12:
            if i == " ":
                ...
                nrune = IndexToRunes[int(i)]
                nbase1str += nrune
                nbase11str += RuneToText[nrune]
